<ul class="social text-right">
    <?php if(get_field('option_facebook','option')): ?>
        <li>
            <a href="<?= get_field('option_facebook', 'option'); ?>" rel="noopener" target="_blank">
    ...
    <?php if(get_field('option_instagram','option')): ?>
        <li>
            <a href="<?= get_field('option_instagram', 'option'); ?>" rel="noopener" target="_blank">
    ...
    <?php if(get_field('option_linkedin','option')): ?>
        <li>
            <a href="<?= get_field('option_linkedin', 'option'); ?>" rel="noopener" target="_blank">
    ...
    <?php if(get_field('option_pinterest','option')): ?>
        <li>
            <a href="<?= get_field('option_pinterest', 'option'); ?>" rel="noopener" target="_blank">
