...
```php
/* functions.php */
use harmonyuse harmonyuse harmonyuse harmonyuse harmonyRoutes::map('myfoo/bar', 'my_callback_function');
...
```php
<?php
use harmonyuse harmonyuse harmonyuse harmonyuse harmonyuse harmonyuse harmonyRoutes::map('blog/:name', function($params){
...
```php
<?php
use harmonyuse harmonyuse harmonyRoutes::map('info/:name/page/:pg', function($params){
